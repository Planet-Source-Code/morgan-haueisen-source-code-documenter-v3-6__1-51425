...
Begin VB.Form frmMultiPgPreview 
   ...
   Begin VB.PictureBox picGoto 
      ...
      Begin VB.TextBox txtGoto 
         ...
         Width           =   1590
      End
      Begin VBProjDoc.chameleonButton cmdGotoOK 
         Height          =   255
         Left            =   2130
         TabIndex        =   35
         Top             =   465
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VBProjDoc.chameleonButton cmd_quit 
         ...
         VALUE           =   0   'False
      End
      Begin VBProjDoc.chameleonButton cmd_print 
         Height          =   630
         Left            =   15
         TabIndex        =   29
         Top             =   660
         ...
         VALUE           =   0   'False
      End
      Begin VBProjDoc.chameleonButton cmdFullPage 
         Height          =   510
         Left            =   15
         TabIndex        =   30
         Top             =   1305
         ...
         VALUE           =   0   'False
      End
      Begin VBProjDoc.chameleonButton Command1 
         Height          =   345
         Index           =   0
         Left            =   45
         TabIndex        =   31
      ...
      Begin VBProjDoc.chameleonButton Command1 
         ...
         VALUE           =   0   'False
      End
      Begin VBProjDoc.chameleonButton cmdGoTo 
         Height          =   510
         Left            =   45
         TabIndex        =   33
         Top             =   2970
   ...
   Begin VB.PictureBox picPrintOptions 
      ...
      Begin VB.TextBox txtTo 
         ...
         Width           =   420
      End
      Begin VBProjDoc.chameleonButton cmdPrint 
         Height          =   360
         Left            =   2265
         TabIndex        =   34
         Top             =   2070
   ...
   Begin VB.PictureBox picGetFolder 
      ...
      Begin VB.CommandButton cmdUpOne 
         ...
         Width           =   375
      End
      Begin VBProjDoc.chameleonButton cmdQuit 
         Height          =   375
         Left            =   3270
         TabIndex        =   36
         Top             =   3975
         ...
         VALUE           =   0   'False
      End
      Begin VBProjDoc.chameleonButton cmdOpen 
         Height          =   375
         Left            =   4755
         TabIndex        =   37
         Top             =   3975
