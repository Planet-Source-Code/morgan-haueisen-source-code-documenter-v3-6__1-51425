...
'// Add true XP theme support on 7/14/2004
...
Private Const C_DT_CENTER As Long = &H15& '&H1 Or C_DT_WORDBREAK Or &H4&
...
Private mlngpDC           As Long
Private mlngpBM           As Long
Private mlngoBM           As Long  '// used for the treansparent button
...
Private Sub DrawPictures(ByVal vbytState As Byte)
   ...
   With UserControl
      ...
      Case 0 '// normal & hover
         ...
         Else
            If mudtButtonType = [Office XP] Then
      ...
      Case 1 '// down
         If mPicHover Is Nothing Or mudtButtonType = [Office XP] Then
            Select Case mudtButtonType
            Case [Java metal], [Office XP]
               Call DoFX(0, mPicNormal)
               Call TransBlt(.hdc, mudtPicPt.x, mudtPicPt.y, mudtPicSz.x, mudtPicSz.y, mPicNormal, mlngClrMask)
            Case Else
               Call DoFX(1, mPicNormal)
...
Private Sub UserControl_Terminate()
   ...
   If mlngpDC Then
      DeleteObject SelectObject(mlngpDC, mlngoBM)
      DeleteDC mlngpDC
   End If
